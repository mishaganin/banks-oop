...
public class DepositAccount : IAccount, IAccrueObserver
{
    ...
    public DepositAccount(Bank bank, decimal balance, decimal percent, decimal withdrawLimit, DateTime expirationDate, Client client, bool isQuestionable)
    {
        Bank = bank;
        Balance = balance;
        Percent = percent / 100;
    ...
    private bool IsExpirationDatePassed()
    {
